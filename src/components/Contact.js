          ...
          <form onSubmit={handleSubmit}>
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="fullname" name="fullname" value={formData.name} />
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                ...
                <textarea class="form-control" id="message" name="message" rows="3" value={formData.message} onChange={handleChange}></textarea>
              </div>
              <div class="col-12">
                <div class="d-grid">
